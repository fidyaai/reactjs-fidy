...
export default class FormElement extends React.Component{
    ...
    render(){
       return( 
           <div style={{margin: '100px auto', border: '1px solid salmon', padding: '20px'}}>
               <form onSubmit={this.handleSubmit}>
                    <label>
                        Nama : 
                        <input type="text" name="nama" onChange={e => this.setState({nama: e.target.value})}
                    ...
                    <label>
                        Alamat : 
                        <textarea cols="30" rows="8" name="alamat" 
                        onChange={e => this.setState({alamat: e.target.value})} defaultvalue={this.state.alamat}/>
                    </label>
                    <br/>
                    <label>
